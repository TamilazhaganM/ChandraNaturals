/**
 * Centralized Site & Client Configuration for Chandra Naturals
 * 
 * IMPORTANT: Replace the placeholder values below with the client's actual
 * contact details, social handles, and regulatory numbers.
 */
export const siteConfig = {
  brandName: "Chandra Naturals",
  ...
  deliveryNote: "Free local delivery on orders above ₹600. Calculated during confirmation on WhatsApp."
};
